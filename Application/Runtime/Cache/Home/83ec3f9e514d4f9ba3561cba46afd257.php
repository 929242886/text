...
<div id="body">
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
     	        ...
     	        <dd><a class="hover" href="/xiangmu/text/index.php/Home/Usercenter/index">我的简历</a></dd>
                <dd><a href="/xiangmu/text/index.php/Home/Usercenter/invite">收到邀请</a></dd>
...
<input type="hidden" id="hasSidebar" value="1">	<div class="content user_modifyContent">
        <dl class="c_section">
            <dd>
            	            	...
            	            	<form id="updatePswForm" action="/xiangmu/text/index.php/Home/Usercenter/doadd" method="post" enctype="multipart/form-data" >
            		<!-- <table class="savePassword">
            			...
            			<tr>
            				...
            				<td>
            					<input type="text" maxlength="16" id="oldpassword" name="oldpassword" style="background-image: url(images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
            					<span id="updatePwd_beError" style="display:none;" class="error">
            				</span></td>            				
            			</tr>
            			<tr>
            				<td width="100px" class="label">邮箱</td>
            				<td><input type="text" maxlength="16" id="newpassword" name="newpassword" style="background-image: url(images/img/a6y3y0Wx5kbFHvGuXzkgf0xhKnPzA4UTyaTB8Ph8AvcHi3fnsrZ7Wore02YViqVOrRXXPhfqP8j6MYlawoAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;"></td>
            			</tr>
            			<tr>
            				<td class="label">确认密码</td>
            				<td><input type="text" maxlength="16" id="comfirmpassword" name="comfirmpassword" style="background-image: url(images/img/a6y3y0Wx5kbFHvGuXzkgf0xhKnPzA4UTyaTB8Ph8AvcHi3fnsrZ7Wore02YViqVOrRXXPhfqP8j6MYlawoAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;"></td>
            			</tr>
            			<tr>
            				<td>&nbsp;</td>
            		...
            		<input type="hidden" name="u_id" value="<?php echo $u_id; ?>">
            			<tr>
            				<td>姓名：</td>
            				<td><input type="text" name="r_name" value="<?php echo $arr['r_name']; ?>"></td>
            			</tr>
            			<tr>
            				<td>性别：</td>
            				<td>
            			...
            			<tr>
            				<td>年龄：</td>
            				<td>
            					<input type="text" name="r_age" value="<?php echo $arr['r_age']; ?>">
            				</td>
            			</tr>
            			<tr>
            				<td>出生年月：</td>
            				<td>
            					<input type="date" name="r_born" value="<?php echo $arr['r_born']; ?>"><?php echo $arr['r_born']; ?>
            				</td>
            			</tr>
            			<tr>
            				<td>手机号：</td>
            				<td><input type="text" name="r_tel" value="<?php echo $arr['r_tel']; ?>"></td>
            			</tr>
            			<tr>
            				<td>邮箱：</td>
            				<td><input type="text" name="r_email" value="<?php echo $arr['r_email']; ?>"></td>
            			</tr>
            			<tr>
            				<td>毕业学校：</td>
            			...
            			<img src="/xiangmu/text/Public/Uploads/<?php echo $arr['r_img']; ?>" alt="" onerror="javascript:this.src='/xiangmu/text/Public/Uploads/1.jpg';" width="100px" height="100px">
...
<script type="text/javascript" charset="utf-8" src="/xiangmu/text/Public/bianjiqi/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/xiangmu/text/Public/bianjiqi/ueditor.all.min.js"> </script>
