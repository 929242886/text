...
<link href="/Public/css/external.min.css" type="text/css" rel="stylesheet">
...
<script src="/Public/js/jquery.lib.min.js" type="text/javascript"></script>
	...
	<div id="header">
    	<div class="wrapper">
    		<a class="logo" href="/index.php">
    			<img width="229" height="43" alt="拉勾招聘-专注互联网招聘" src="/Public/images/logo.png">
    		</a>
...
<input type="hidden" id="hasSidebar" value="1">	<div class="content user_modifyContent">
    <dl class="c_section">
        <dd>
    		<form id="updatePswForm" action="/index.php/Home/Usercenter/doadd" method="post" enctype="multipart/form-data" onsubmit="return check_all()" >
    			<div id="tab">
            	<table style="position:relative;">
					...
					<div id="img">
					<img src="/Public/Uploads/<?php echo $arr['r_img']; ?>" alt="" onerror="javascript:this.src='/Public/Uploads/1.jpg';" width="100px" height="100px">
...
<script type="text/javascript" charset="utf-8" src="/Public/bianjiqi/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/Public/bianjiqi/ueditor.all.min.js"> </script>
