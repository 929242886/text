...
<li>|</li>
<li><a href="enterprise.html" rel="nofollow">企业登陆</a></li>
</ul>
</div>
</div><!-- end #header -->
...
<div class="clearfix">
<div class="content_l">
<form id="companyListForm" name="companyListForm" method="get" action="/index.php/Home/Index/search">
...
<dt>面试职位:</dt>
<dd>
     <a href="" class="moren">不限</a>
     <?php if(is_array($positionall)): foreach($positionall as $key=>$p): ?><a href=""><?php echo ($p["p_name"]); ?></a><?php endforeach; endif; ?>
</dd>
</dl>
<dl>
<dt>工作经验：</dt>
<dd>
<a href="" class="moren">不限</a>
<?php if(is_array($experienceall)): foreach($experienceall as $key=>$e): ?><a href=""><?php echo ($e["e_year"]); ?></a><?php endforeach; endif; ?>
    </dd>
</dl>
<dl>
<dt>期望薪资：</dt>
<dd>
<a href="" class="moren">不限</a>
<?php if(is_array($moneyall)): foreach($moneyall as $key=>$m): ?><a href=""><?php echo ($m["m_money"]); ?></a><?php endforeach; endif; ?>
</dd>
</dl>
</dd>
</dl>
...
<div id="banner">
		...
		<?php foreach($resumeoneall as $k => $v): ?>
		 ...
		 <?php endforeach ?>
		 <a href="/index.php/Home/Index/">更多....</a>
</div>
...
<script type="text/javascript">
$(function(){
		$(".hc_tag dl a").click(function(){
			//alert("dwadaw");
		    $(this).addClass("moren");
			$(this).parent("dd").each(function () {
