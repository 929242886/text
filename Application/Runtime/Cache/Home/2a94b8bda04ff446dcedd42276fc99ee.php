...
<div id="banner">
		...
		<?php foreach($resumeoneall as $k => $v): ?>
				<li  style="<?php if($k < 1){ ?>echo 'clear:both;'<?php }?>" >
					<a href="/text/index.php/Home/Resume/index?r_id=<?php echo $v['r_id']?>" target="_blank">
					<h3 title="<?php echo $v['r_name']?>"><?php echo $v['r_name']?></h3>
					<div class="comLogo">
					<img src="/text/Public/images/grass.jpg" width="190" height="190" alt="<?php echo $v['r_name']?>" />
					</div>
					</a>
					<a href="/text/index.php/Home/Resume/index?r_id=<?php echo $v['r_id']?>" target="_blank">环境监测工程师</a>
					<ul class="reset ctags">
						<li><?php echo $v['r_school']?></li>
					</ul>
				</li>
		 <?php endforeach ?>
		 <a href="/text/index.php/Home/Index/index?pid=1">更多....</a>
</div>
   <div id="banner_center">
		...
		<?php foreach($resumetwoall as $k => $v): ?>
		 ...
		 <?php endforeach ?>
		 <a href="/text/index.php/Home/Index/index?pid=2">更多....</a>
   </div>
<div id="banner_buttom">
		...
		<?php foreach($resumethreeall as $k => $v): ?>
		 ...
		 <?php endforeach ?>
		 <a href="/text/index.php/Home/Index/index?pid=3">更多....</a>
   </div>
...
<script type="text/javascript" src="/text/Public/style/js/company_list.min.js"></script>
<script>
$(function(){
/*分页 */
$('.Pagination').pager({
...
<script type="text/javascript" src="/text/Public/style/js/core.min.js"></script>
<script type="text/javascript" src="/text/Public/style/js/popup.min.js"></script>
<script type="text/javascript">
$(function(){
