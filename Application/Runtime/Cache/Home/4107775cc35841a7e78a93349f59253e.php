...
<script type="text/javascript" src="/Public/styles/js/jquery.min.js"></script>
<script type="text/javascript" src="/Public/styles/js/custom.js"></script>
...
<div id="body">
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
                <dt style="margin-left:3px"><h4><font color='#999999'><a href="/index.php"><font color='#999999'>首页</font></a>>个人中心>我的账号</font></h4></dt>
                <dd><a href="index">我的账号</a></dd>
        <dd><a href="invite">已邀请人才</a></dd>
        <dd><a href="update">修改密码</a></dd>
            </dl>
            <div id='tui' style="display:block">
             <h4 style="margin-left:3px"><span ><font color='#999999'>今日为您推荐</font><font id='close' style="cursor:pointer;float:right" onclick="closes();"><img src="/Public/images/error-blue.png" style="margin-left:105px" width='20px' height='20px' alt=""></font></span></h4>
             <div>
...
<div class="content user_modifyContent">
        <dl class="c_section">
            ...
            <dd>
                                ...
                                <form action="/index.php/Home/Company/index" method='post' enctype="multipart/form-data">
                    ...
                    <table class="savePassword">
                       ...
                       <tr>
                            ...
                            <td>
                                <span><img src="/Public/Uploads/<?php echo ($data["e_photo"]); ?>" alt="" style="width:90px;height:80px"></span><input type="file" id='e_photo' name="e_photo">
                             </td>                            
                        </tr>
                        <tr>
                            <td></td>
