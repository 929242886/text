...
<body style="background: #E6EBF5;" >

<div style="margin-top: 20px;background: #8080FF;">
<div class="example" style="margin-left: 300px;">
   <a href="/index.php/Home/Index/index"><font size='6'>首页</font></a> 
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="/index.php/Home/Index/index"><font size='6'>返回</font></a>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   
   <?php
 if(!empty($arr1)){ echo "<a href='javascript:;' class='rollIn dialog'><font size='6' >邀请</font></a>"; }else{ echo "<a href='/index.php/Home/Resume/Login/index'><font size='6' >邀请|请登录</font></a>"; } ?>
    
        
    
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <form action="/index.php/Home/Index/index">
    <div style="margin-left:800px;">
    <input type="text" name="sou" id=""/>
    <input type="submit" value="搜索" />
        ...
        <div id="HBox">
            <?php if(is_array($arr1)): foreach($arr1 as $key=>$v): ?><form action="/index.php/Home/Resume/iphone" method="post" >
                <ul class="list">
                    <li>
...
<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><img style="width:150px; height:150px; border-radius:50%; overflow:hidden;" src="/Public/uploads/1.jpg" alt="正方形的原始图片" /><?php endforeach; endif; ?>
</div>
</div>
<div class="form-left-div"></div>
<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><div class="form-center-div">
  <ul>
    <li>真实姓名: <?php echo ($v["r_name"]); ?> </li>
    <li>出生年月: <?php echo ($v["r_born"]); ?> </li>
    <li>性别：
    ...
    <li>移动电话: 
        <?php
 if(!empty($arr1)){ echo $v['r_tel']; }else{ echo "请登录后再查看！"; } ?>
     </li>
    <li>电子邮件: 
        <?php
 if(!empty($arr1)){ echo $v['r_email']; }else{ echo "请登录后再查看！"; } ?>
     </li>
    <li>家庭住址: <?php echo ($v["r_address"]); ?> </li>
  </ul>
<h2>求职意向:</h2>
<p>寻一份<?php echo ($v["p_name"]); ?>工作</p>
<h2>精通技能技能:</h2>
<p><?php echo ($v["r_skill"]); ?></p>
<h2>做过的项目：</h2>
<p><?php echo ($v["r_project"]); ?></p>
<h2>自我评价：</h2>
<p><?php echo ($v["r_evaluate"]); ?></p>
<h2>导师评价：</h2>
<p>
    <div id="box">
           <?php echo ($arr2[0]["e_situation"]); ?>       
    </div>
</p>
...
<script>
/*function search(){
    var sou = document.getElementById('zhi').value;
    $.ajax({
