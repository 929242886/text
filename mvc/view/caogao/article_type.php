...
<div id="sort_new" class="item_edit">
	...
	<li><input maxlength="200" style="width:243px;" class="input" name="name" id="sortname" /> 名称<span class="required">*</sapn></li>

	<li><input maxlength="200" style="width:243px;" class="input" name="asname" id="alias" /> 别名 (用于URL的友好显示)</li>
	<li><input type="radio" name="is_show" value='1'>显示<input type="radio" name="is_show" value = "0">不显示</li>


	<li>分类描述<br />

	<textarea name="miaoshu" type="text"  site = "20" maxlength="20" style="width:240px;height:60px;overflow:auto;" class="textarea"></textarea></li>
