<?php
/* Smarty version 3.1.29, created on 2016-05-04 09:55:47
  from "E:\phpstudy\WWW\mvc\view\article\article_up.php" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_572956a31e9d53_48353529',
  'file_dependency' => 
  array (
    '9a68701e4fa2af4c02cee0f47b3d9c331a518b33' => 
    array (
      0 => 'E:\\phpstudy\\WWW\\mvc\\view\\article\\article_up.php',
      1 => 1462326940,
      2 => 'file',
    ),
  ),
...
function content_572956a31e9d53_48353529 ($_smarty_tpl) {
...
<div class="containertitle"><b>编辑文章</b><span id="msg_2"></span></div>
<div id="msg"></div>
<form action="?a=up_pro&c=article" method="post" enctype="multipart/form-data" id="addlog" name="addlog">
<div id="post">
    <div>
        <input value='<?php echo $_smarty_tpl->tpl_vars['re']->value['title'];?>
' type="text" maxlength="200" name="title" id="title"/>
    </div>
    <div>
<span class="field">
        <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['re']->value['id'];?>
"  name="id">
            <textarea id="editor1" onblur='editor1()' name="sit_content"><<?php echo $_smarty_tpl->tpl_vars['re']->value['content'];?>
></textarea>
            &nbsp;&nbsp;&nbsp;&nbsp;<sp id='sp_editor1'></sp>
        </span>
        <?php echo '<script'; ?>
...
?>
            ...
            <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['t_id'];?>
" <?php if ($_smarty_tpl->tpl_vars['re']->value['t_id'] == $_smarty_tpl->tpl_vars['v']->value['t_id']) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['t_name'];?>
</option>
...
?>
        ...
        发布于：<input  type="date" style="width:139px;" name="postdate" id="postdate" value="<?php echo $_smarty_tpl->tpl_vars['re']->value['datetime'];?>
"/>
        <div id="tagbox">
        <?php if ($_smarty_tpl->tpl_vars['tag']->value) {?>
        <?php
$_from = $_smarty_tpl->tpl_vars['tag']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
?>
    ...
    <div style="margin-top:3px;">
        ...
        <select name="caogao" >
            ...
            <input type="checkbox"  name="sortop" d="sortop" />
    ...
    <div id="post_button">
        ...
        <input type="submit" value="保存" onclick="return checkform();" class="button" />
