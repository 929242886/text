...
<form class="form-inline definewidth m20" action="/xiangmu/text/admin.php/Home/Condition/position" method="get">
    职位名称：
    ...
    <button type="submit" class="btn btn-primary">查询</button>
 	...
 	<form action="/xiangmu/text/admin.php/Home/Condition/delete" method="get">
