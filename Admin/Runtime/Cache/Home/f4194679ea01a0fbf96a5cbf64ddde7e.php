...
<body>
	...
	<li>
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Condition/../resume/resume">
								<i class="icon-double-angle-right"></i>
								学生简历
							</a>
						</li> 
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Condition/../condition/position">
								<i class="icon-double-angle-right"></i>
								职位
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Condition/../condition/experience">
								<i class="icon-double-angle-right"></i>
								经验
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Condition/../condition/salary">
								<i class="icon-double-angle-right"></i>
								薪资
							</a>
						</li> 
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Condition/../Student/student">
								<i class="icon-double-angle-right"></i>
								老师评价
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Condition/../Student/viewcomments ">
								<i class="icon-double-angle-right"></i>
								查看我的评价
							</a>
						</li> 
...
<form class="form-inline definewidth m20" action="/admin.php/Home/Condition/salary" method="get">
    薪资名称：
    ...
    <button type="submit" class="btn btn-primary">查询</button>
 	...
 	<form action="/admin.php/Home/Condition/salary_del_up_add" method="get">
	...
	<?php foreach ($arr as $key => $value): ?> 
	    <tr>
	    <td><input type="checkbox" name="m_id[]" id="m_id[]" value="<?php echo $value['m_id']?>"></td>
...
<script>
	$('#submit').click(function(){
		text = $("input:checkbox[name='m_id[]']:checked").map(function(index,elem) {
			return $(elem).val();
		}).get().join(',');
		if (text=='') {
			alert('请选择删除内容')
