...
<body>
	...
	<li>
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Index/../resume/resume">
								<i class="icon-double-angle-right"></i>
								学生简历
							</a>
						</li> 
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Index/../condition/position">
								<i class="icon-double-angle-right"></i>
								职位
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Index/../condition/experience">
								<i class="icon-double-angle-right"></i>
								经验
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Index/../condition/salary">
								<i class="icon-double-angle-right"></i>
								薪资
							</a>
						</li> 
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Index/../Student/student">
								<i class="icon-double-angle-right"></i>
								老师评价
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Index/../Student/viewcomments ">
								<i class="icon-double-angle-right"></i>
								查看我的评价
							</a>
						</li> 
