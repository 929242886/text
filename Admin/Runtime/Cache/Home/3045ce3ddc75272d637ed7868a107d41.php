...
<form class="form-inline definewidth m20" action="/xiangmu/text/admin.php/Home/Condition/experience" method="get">
    经验名称：
    ...
    <button type="submit" class="btn btn-primary">查询</button>
 	...
 	<form action="/xiangmu/text/admin.php/Home/Condition/experience_delete" method="get">
