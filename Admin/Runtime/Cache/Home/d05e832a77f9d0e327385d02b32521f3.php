...
<body>
	...
	<li>
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Resume/../resume/resume">
								<i class="icon-double-angle-right"></i>
								学生简历
							</a>
						</li> 
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Resume/../condition/position">
								<i class="icon-double-angle-right"></i>
								职位
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Resume/../condition/experience">
								<i class="icon-double-angle-right"></i>
								经验
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Resume/../condition/salary">
								<i class="icon-double-angle-right"></i>
								薪资
							</a>
						</li> 
					...
					<ul class="submenu">
						<li>
							<a href="/admin.php/Home/Resume/../Student/student">
								<i class="icon-double-angle-right"></i>
								老师评价
							</a>
						</li> 
						...
						<li>
							<a href="/admin.php/Home/Resume/../Student/viewcomments ">
								<i class="icon-double-angle-right"></i>
								查看我的评价
							</a>
						</li> 
...
<form class="form-inline definewidth m20" action="/admin.php/Home/Resume/resume" method="get">
    简历名称：
    ...
    <button type="submit" class="btn btn-primary">查询</button>
 	...
 	<?php if($arr){ ?>
 	<form action="/admin.php/Home/Resume/delete" method="post">
	...
	<?php foreach ($arr as $key => $value): ?>
	    ...
	    <td><input type="checkbox" name="r_id[]" id="r_id[]" value="<?php echo $value['r_id']?>"></td>
	        ...
	        <td>
	        	<a href="/admin.php/Home/Resume/details/r_id/<?php echo $value['r_id']?>">详情</a> 
