...
<form class="form-inline definewidth m20" action="/xiangmu/text/admin.php/Home/Resume/resume" method="get">
    简历名称：
    ...
    <button type="submit" class="btn btn-primary">查询</button>&nbsp;&nbsp; <button type="button" class="btn btn-success" id="addnew">新增机构</button>
 	...
 	<?php if($arr){ ?>
 	<form action="/xiangmu/text/admin.php/Home/Resume/delete" method="post">
	...
	<?php foreach ($arr as $key => $value): ?>
	    ...
	    <td><input type="checkbox" name="r_id[]" id="r_id[]" value="<?php echo $value['r_id']?>"></td>
	        ...
	        <td>
	        	<a href="/xiangmu/text/admin.php/Home/Resume/details/r_id/<?php echo $value['r_id']?>">详情</a> 
	        </td> 
	    </tr>
<?php endforeach ?>
    </table>
