...
<body>
	...
	<li>
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="/text/admin.php/Home/Resume/../resume/resume">
								<i class="icon-double-angle-right"></i>
								学生简历
							</a>
						</li> 
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="/text/admin.php/Home/Resume/../condition/position">
								<i class="icon-double-angle-right"></i>
								职位
							</a>
						</li> 
						...
						<li>
							<a href="/text/admin.php/Home/Resume/../condition/experience">
								<i class="icon-double-angle-right"></i>
								经验
							</a>
						</li> 
						...
						<li>
							<a href="/text/admin.php/Home/Resume/../condition/salary">
								<i class="icon-double-angle-right"></i>
								薪资
							</a>
						</li> 
...
<form class="form-inline definewidth m20" action="/text/admin.php/Home/Resume/resume" method="get">
    简历名称：
    ...
    <button type="submit" class="btn btn-primary">查询</button>
 	...
 	<?php if($arr){ ?>
 	<form action="/text/admin.php/Home/Resume/delete" method="post">
	...
	<?php foreach ($arr as $key => $value): ?>
	    ...
	    <td><input type="checkbox" name="r_id[]" id="r_id[]" value="<?php echo $value['r_id']?>"></td>
	        ...
	        <td>
	        	<a href="/text/admin.php/Home/Resume/details/r_id/<?php echo $value['r_id']?>">详情</a> 
